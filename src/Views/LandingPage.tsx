...
const LandingPage = () => {
    return (
        <section
            className='bg-gradient-radial from-[#DDEB78] via-[#FCF9F1] to-[#BEECDD] h-screen w-full flex flex-col gap-y-4 items-center justify-between px-4 pt-4 overflow-y-hidden text-center'>
            ...
            <div className='w-full flex flex-col gap-y-4 items-center'>
                ...
                <button
                    className='hover:bg-white bg-[#DDEB78] rounded-lg px-4 py-2 text-xl md:text-2xl border-black border-2'>
                    <a href="./Guestmap">Guest</a></button>
            </div>
