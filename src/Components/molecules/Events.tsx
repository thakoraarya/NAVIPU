...
const Events = () => {
  return (
    <div className=' w-[20%] rounded-tl-3xl overflow-y-auto bg-[#fcf9f1] border-[#78786a] md:flex md:flex-col items-center gap-y-6 border-2 border-r-0 border-b-0 p-[1.7%]'>
