...
const Places: React.FC<PlacesProps> = ({ onCardClick }) => {
  ...
  return (
    <section
      className='overflow-hidden flex flex-col items-center gap-y-4 min-w-fit min-h-full px-4 py-5 lg:p-[1.7%] border-[#78786a] lg:bg-light-surface-container-low rounded-t-3xl border-b-0 border-2 lg:border-l-0 lg:rounded-tl-none lg:backdrop-blur-none  lg:bg-none backdrop-blur-md backdrop-filter bg-light-surface-container/20'>
