...
const Places: React.FC<PlacesProps> = ({onCardClick}) => {
    ...
    return (
        <section
            className='overflow-hidden flex flex-col items-center gap-2 min-w-fit min-h-full rounded-tr-3xl border-l-0 border-b-0 border-[#78786a] border-2 gap-y-6 p-[1.7%]'>
