    ...
    content: ['./src/**/*.{js,ts,jsx,tsx,mdx}', './app/**/*.{js,ts,jsx,tsx,mdx}'], theme: {
        extend: {
            backgroundImage: {
                ...
                // Light Theme
                light: {
                    'primary': '#526600', 'on-primary': '#ffffff', 'primary-container': '#caf234', 'secondary': '#5b6146', 'on-secondary': '#ffffff', 'secondary-container': '#e0e6c4', 'tertiary': '#3a665e', 'on-tertiary': '#ffffff', 'tertiary-container': '#bdece1', 'error': '#ba1a1a', 'error-container': '#ffdad6', 'on-error': '#ffffff', 'on-error-container': '#410002', 'background': '#fefcf4', 'on-background': '#1b1c17',
                    'surface': '#fefcf4',
                    'surface-container': '#F0EEE6',
                    'on-surface': '#1b1c17', 'surface-variant': '#e3e4d3', 'on-surface-variant': '#46483c', 'outline': '#77786b', 'inverse-on-surface': '#f3f1e9', 'inverse-surface': '#30312b', 'inverse-primary': '#afd506', 'shadow': '#000000', 'surface-tint': '#526600', 'outline-variant': '#c7c8b8', 'scrim': '#000000',
                },
